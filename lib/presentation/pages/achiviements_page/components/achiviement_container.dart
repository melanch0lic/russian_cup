  ...
  Widget build(BuildContext context) {
    return !achievement.isCompleted
        ? Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, mainAxisSize: MainAxisSize.min, children: [
              ...
              Text(
                ...
                style:
                    const TextStyle(color: Color.fromRGBO(29, 31, 36, 0.5), fontSize: 18, fontWeight: FontWeight.w600),
                ...
                children: [
                  Text(achievement.countPoints.toString(),
                      style: const TextStyle(
                          color: Color.fromRGBO(29, 31, 36, 0.5), fontSize: 20, fontWeight: FontWeight.w600)),
                  const SizedBox(width: 8),
                  Opacity(opacity: 0.5, child: SvgPicture.asset('assets/svg_icons/light.svg', height: 24, width: 24)),
                ],
              )
            ]),
          )
        : Container(
            ...
            width: double.infinity,
            decoration: const BoxDecoration(
                color: Color.fromRGBO(246, 247, 250, 1), borderRadius: BorderRadius.all(Radius.circular(24))),
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, mainAxisSize: MainAxisSize.min, children: [
              Image.asset('assets/images/achiv_win.png'),
              Text(
                achievement.name.toString(),
                style: const TextStyle(color: Color.fromRGBO(29, 31, 36, 1), fontSize: 18, fontWeight: FontWeight.w600),
                textAlign: TextAlign.center,
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text(achievement.countPoints.toString(),
                      style: const TextStyle(
                          color: Color.fromRGBO(29, 31, 36, 1), fontSize: 20, fontWeight: FontWeight.w600)),
                  const SizedBox(width: 8),
                  SvgPicture.asset('assets/svg_icons/light.svg', height: 24, width: 24),
                ],
              )
            ]),
          );
...
class Achievement {
  ...
  Achievement({required this.isCompleted, required this.name, required this.countPoints});
}
